...
"""The Python implementation of the GRPC helloworld.Greeter server with OpenTelemetry tracing enabled."""
...
def serve():
    ...
    # Sleep to make sure client made RPC call and the server span is exported.
    time.sleep(10)
